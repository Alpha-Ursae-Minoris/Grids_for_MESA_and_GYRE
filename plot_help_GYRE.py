...
def single_gyre_plot(
    ...
    for model in model_directories:
        ...
        for index in indices:
            profile_data_indices = np.where(index == profile_numbers)[
                0
